<?php require('header.php'); ?>
			...
			<ul class="breadcrumb" style="margin-top:1px;">
				<li>
					<i class="icon-home"></i>
					<a href="index.php">Bus Transport Management Information System</a> 
				...
				<li><a href="#">Viewing Schedule</a></li>
						...
						<h2 style="text-indent:20px;">Balanga City to Mariveles </h2>
						  <thead>
							  <tr>
								  <th>Driver Name</th>
								  <th>Bus Number</th>
...
LEFT JOIN driver ON schedule.driverid = driver.driverid
 where destination_location='Balanga City' ORDER BY schedule.scheduleid DESC ") or die (mysql_error());
...
<br />
						...
						<table class="table table-striped table-bordered" style="width:90%; margin:auto;">
						<h2 style="text-indent:20px;">Mariveles to Balanga City </h2>
						  <thead>
							  <tr>
								  <th>Driver Name</th>
								  <th>Bus Number</th>
...
LEFT JOIN bus ON schedule.busid = bus.busid
LEFT JOIN driver ON schedule.driverid = driver.driverid
 where destination_location='Mariveles' ORDER BY schedule.scheduleid DESC ") or die (mysql_error());
while ($row= mysql_fetch_array ($result) ){
$id=$row['scheduleid'];
$busid=$row['busid'];
$driverid=$row['driverid'];
